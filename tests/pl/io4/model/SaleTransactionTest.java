...
public class SaleTransactionTest {
    ...
    public void addOnePercentageDiscountTest() {
        try {
            ...
            Discount discount = new Discount("test", discountValue, DiscountType.PERCENTAGE);

            saleTransaction.addProduct(product);
            saleTransaction.addDiscount(discount, 1);
    ...
    public void addTwoPercentageDiscountsTest() {
        try{
            ...
            double discountValue1 = 2;
            Discount discount1 = new Discount("test", discountValue1, DiscountType.PERCENTAGE);

            double discountValue2 = 2;
            Discount discount2 = new Discount("test", discountValue2, DiscountType.PERCENTAGE);

            saleTransaction.addProduct(product);
            saleTransaction.addDiscount(discount1, 1);
            saleTransaction.addDiscount(discount2, 1);
    ...
    public void addOneVoucherDiscountTest() {
        try{
            ...
            Discount discount = new Discount("test", discountValue, DiscountType.VOUCHER);
    ...
    public void addTwoVoucherDiscountsTest() {
        try {
            ...
            Discount discount1 = new Discount("test1", discountValue1, DiscountType.VOUCHER);

            double discountValue2 = 5;
            Discount discount2 = new Discount("test2", discountValue2, DiscountType.VOUCHER);
    ...
    public void addOneVoucherOnePercentageDiscountsTest() {
        try {
            ...
            Discount discount2 = new Discount("test2", discountValue2, DiscountType.PERCENTAGE);
    ...
    public void overflowPercentageDiscount() {
        try {
            ...
            Discount discount1 = new Discount("test1", discountValue1, DiscountType.PERCENTAGE);
    ...
    public void overflowCatchAndTryAgainDiscount() {
        try {
            try{
                ...
                Discount discount3 = new Discount("test3", discountValue3, DiscountType.VOUCHER);
                saleTransaction.addDiscount(discount3, 1);
